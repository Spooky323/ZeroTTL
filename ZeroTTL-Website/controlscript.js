...
// function detect() {
//   // Add Delay to make the camera FPS higher
//   setTimeout(function(){
...
//   ctx.drawImage(CurrentCamera, 0, 0);
//   if (objects.length > 0){
...
function changeLight(light){
  if(activeLight == light){return }
  // Only if selected light is red
  if(light == 0){
  ...
  setTimeout(function(){
    ...
    circles[activeLight].className = 'circle';
    circles[light].classList.add(circles[light].getAttribute('color'))
    activeLight = light;
  },1000)
}
